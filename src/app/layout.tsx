...
const inter = Inter({
  subsets: ["latin"],
  variable: "--font-inter",
  // 300 dropped: no font-light usage anywhere, so it was a wasted font file.
...
export const metadata: Metadata = {
  ...
  description:
    "North India's most results-driven digital marketing institute. 500+ students trained. Written placement guarantee. Master Google Ads, SEO, Meta Ads & AI Tools. Online & offline — Sonipat campus serving Haryana & Delhi NCR.",
  keywords: [
...
const structuredData = {
  ...
  description: "North India's most results-driven digital marketing institute. 500+ students trained. Written placement guarantee. Haryana & Delhi NCR.",
  address: {
    "@type": "PostalAddress",
  ...
  return (
    <html lang="en" className={`${montserrat.variable} ${inter.variable}`}>
      ...
      <body className="bg-midnight text-white font-body antialiased">
        ...
        {/* Meta Pixel — lazyOnload keeps ~180KB of pixel JS off the critical
            path; it still fires PageView once the page has loaded. */}
