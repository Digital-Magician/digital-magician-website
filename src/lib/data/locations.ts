...
export const locations: LocationData[] = [
...

  {
    ...
    mode: "nearby",
    metaTitle: "Digital Marketing Course in Panipat | Placement Guaranteed",
...

  {
    ...
    mode: "medium",
    metaTitle: "Digital Marketing Course in Kurukshetra | Real Training",
...

  {
    ...
    mode: "medium",
    metaTitle: "Digital Marketing Training Institute in Rohtak | Placement",
...

  {
    ...
    mode: "medium",
    metaTitle: "Digital Marketing Course in Gurugram | Real Campaigns",
...

  {
    ...
    travelTime: "2.5–3 hours",
    mode: "far",
    metaTitle: "Digital Marketing Course in Yamunanagar | Live Online Batch",
...

  {
    ...
    mode: "medium",
    metaTitle: "Digital Marketing Course in Rewari | Online + Placement",
...

  {
    ...
    travelTime: "2–2.5 hours",
    mode: "far",
    metaTitle: "Digital Marketing Course in Mahendragarh | Online Classes",
...

  {
    ...
    travelTime: "1.5–2 hours",
    mode: "far",
    metaTitle: "Digital Marketing Course in Charkhi Dadri | Online Batch",
...

  {
    ...
    mode: "nearby",
    metaTitle: "Digital Marketing Course for North Delhi | Online Batch",
...

  {
    ...
    travelTime: "55–70 minutes via NH44",
    mode: "medium",
    metaTitle: "Digital Marketing Course for Central Delhi | Online Training",
...

  {
    ...
    mode: "medium",
    metaTitle: "Digital Marketing Course for SW Delhi / Dwarka | Online",
...

  {
    ...
    mode: "nearby",
    metaTitle: "Digital Marketing Course in Ganaur | 20 Mins From Campus",
...

  {
    ...
    mode: "far",
    metaTitle: "Digital Marketing Course in Sohna | Online + Placement",
